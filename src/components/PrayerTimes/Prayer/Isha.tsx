...
export default function Isha({language}: {language: string}) {
  const prayerData = [
    {
      heading: language === "en" ? English.shalat.intentionRead[4].title : Indonesian.shalat.intentionRead[4].title,
      arabic: language === "en" ? English.shalat.intentionArab[15].subTitle : Indonesian.shalat.intentionArab[15].subTitle,
      latin: language === "en" ? English.shalat.intentionLatin[15].subTitle : Indonesian.shalat.intentionLatin[15].subTitle,
      meaning: language === "en" ? English.shalat.meaning[15].paragraph : Indonesian.shalat.meaning[15].paragraph,
      imamMakmum: true,
    },
  ];
          ...
          {prayerData.map((data, index) => (
            <div key={index} className="flex flex-col p-5 md:p-10 bg-dark rounded-xl">
              <div className="flex flex-col relative justify-evenly items-center w-full pb-16">
                ...
                <h2 className="text-2xl md:text-3xl text-center ml-auto leading-loose tracking-wide">{data.arabic}</h2>
              </div>
              <h3 className="md:text-2xl italic tracking-wide">{data.latin}</h3>
