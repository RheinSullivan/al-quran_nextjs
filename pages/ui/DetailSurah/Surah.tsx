            ...
            <div className="flex justify-evenly items-center w-full pb-16">
              <span className="flex relative justify-center items-center">
                <div className="flex bg-green-600/20 rounded-full w-10 h-10 items-center justify-center text-center">
                  <p className="text-lg md:text-xl text-green-400 font-bold">{ayat.nomorAyat}.</p>
                </div>
              </span>
              <h2 className="text-xl md:text-3xl text-end ml-auto leading-loose tracking-wide">{ayat.teksArab}</h2>
            </div>
            <h3 className="text-green-500 text-xl font-semibold italic tracking-wide to-slate-900">{ayat.teksLatin}</h3>
            <p className="text-sm mt-3 md:text-lg leading-relaxed">{ayat.teksIndonesia}</p>
          </div>
        ))}
      </div>
    </div>
